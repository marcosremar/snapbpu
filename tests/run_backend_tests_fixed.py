...
Uso:
    python tests/run_backend_tests_fixed.py                    # Todos os testes
    python tests/run_backend_tests_fixed.py --module auth     # Apenas auth
    python tests/run_backend_tests_fixed.py --parallel 4      # Paralelo
    python tests/run_backend_tests_fixed.py --no-cache        # Sem cache
    python tests/run_backend_tests_fixed.py --report json     # Relatório JSON
"""
...
class TestRunner:
    ...
    def run_all_tests(self, use_cache=True, parallel=1, verbose=True, modules=None):
        ...
        for module in test_modules:
            ...
            if result:
                ...
                # Mostrar output se falhou e verbose
    ...
    def print_summary(self, results, success_count, total_duration):
        ...
        print(f"✅ Módulos bem-sucedidos: {success_count}/{total_modules} ({success_rate:.1f}%)")
