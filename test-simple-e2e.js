...
// Teste E2E simplificado do AI Wizard
async function testAIWizardE2E() {
  console.log('🚀 Teste E2E do AI Wizard - Fluxo Completo\n');
  ...
  try {
    ...
    // ETAPA 4: Testar conversa e recomendações
    console.log('\n💬 ETAPA 4: Testando conversa...');
    ...
    console.log('\n📊 ETAPA 7: Análise da comunicação...');
    
    // Enviar mensagem curta para testar se pede mais info
    await page.goto('http://localhost:5173', { waitUntil: 'networkidle2' });
    ...
    console.log('📋 Relatório salvo: /tmp/ai-wizard-e2e-report.json');
